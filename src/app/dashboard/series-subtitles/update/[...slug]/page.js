...
import putMainSeriesSubtitles from "@/database/put/series-subtitles/putMainSeriesSubtitles";
...
export default function UpdateSeriesSubtitles() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const seriesSubtitles = await putMainSeriesSubtitles(
        category,
        id,
        insertData,
        setIsLoading,
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="text-center md:text-start">
            <h1 className="text-2xl font-serif pt-4 pl-5">Update Series</h1>
          </div>
