...
import insertComingSoon from "@/database/insert/insertComingSoon";
...
export default function AddComingSoon() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const seriesSubtitles = await insertComingSoon(
        insertData,
        setIsLoading,
        reset
      );
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="text-center md:text-start">
            <h1 className="text-2xl font-serif pt-4 pl-5">Add Coming Soon</h1>
          </div>
