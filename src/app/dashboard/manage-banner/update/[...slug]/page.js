...
import putBannerMovie from "@/database/put/banner/putBannerMovie";
import putBannerSeriesSubtitles from "@/database/put/banner/putBannerSeriesSubtitles";
  ...
  const onSubmit = async (data) => {
    if (category === "movies") {
      ...
      try {
        ...
        const seriesSubtitles = await putBannerMovie(
          category,
          id,
          insertData,
          setIsLoading,
      ...
      try {
        ...
        // Handle form submission logic here (e.g., save to database)
        // await projectInsert(project, setIsLoading, reset);
        const seriesSubtitles = await putBannerSeriesSubtitles(
          category,
          id,
          insertData,
          setIsLoading,
    ...
    <div className="w-[98%] h-auto mb-5">
      ...
      >
        {category === "movies" ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="text-center md:text-start">
              <h1 className="text-2xl font-serif pt-4 pl-5">Update Banner</h1>
            </div>
            <div className="p-4 text-start">
              {/* Form Fields */}
              <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
