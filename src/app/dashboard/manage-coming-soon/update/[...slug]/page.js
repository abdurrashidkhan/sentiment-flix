...
import useFindOne from "@/database/find/findOne/useFindOne";
import putComingMovie from "@/database/put/putComingMovie";
import putSeriesSubtitles from "@/database/put/putSeriesSubtitles";
import { useParams } from "next/navigation";
import { useEffect, useState } from "react";
import { useAuthState, useSignOut } from "react-firebase-hooks/auth";
import { useForm } from "react-hook-form";

export default function UpdateSeriesSubtitles() {
  ...
  const ContentLoad = async () => {
    setIsLoading(true);
    const { findOneContent } = await useFindOne(category, id);
    setAllContent(findOneContent);
    setIsLoading(false);
  };
  ...
  const onSubmit = async (data) => {
    if (category === "movies") {
      ...
      try {
        ...
        const seriesSubtitles = await putComingMovie(
          category,
          id,
          insertData,
          setIsLoading,
      ...
      try {
        ...
        // Handle form submission logic here (e.g., save to database)
        // await projectInsert(project, setIsLoading, reset);
        const seriesSubtitles = await putSeriesSubtitles(
          category,
          id,
          insertData,
          setIsLoading,
            ...
            <div className="p-4 text-start">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                ...
                <div className="w-full">
                  ...
                  <input
                    ...
                    name="seriesName"
                    type="text"
                    defaultValue={allContent?.seriesName}
                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5 pt-3">
                ...
                <div className="w-full">
                  ...
                  <input
                    id="season"
                    name="season"
                    defaultValue={allContent?.season}
                    type="number"
                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
                    placeholder="Season"
                    {...register("season", {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                <div className="w-full pt-4">
                  ...
                  >
                    <option
                      ...
                      selected
                      disabled
                      defaultValue={allContent?.catagories}
                    >
                      {allContent?.catagories}
                    </option>
                ...
                <div className="w-full pt-4">
                  ...
                  >
                    <option
                      className="py-2 bg-[#1B1B1B]"
                      defaultValue={allContent?.displaySection}
                      selected
                      disabled
                    >
                      {allContent?.displaySection}
                    </option>
                    {/* <option className="py-2 bg-[#1B1B1B]" value="coming-soon">
                      শিঘ্রই দেখতে পাবেন{" "}
                    </option> */}
                    {/* <option className="py-2 bg-[#1B1B1B]" value="popular-series">
                    জনপ্রিয় সিরিজ এবং সাবটাইটেল
                  </option>
                  */}
                    <option className="py-2 bg-[#1B1B1B]" value="movies">
                      Movies
                    </option>
                    {/* <option value="sport">Sport</option> */}
                  </select>
              ...
              <div className="w-full pt-3">
                ...
                >
                  <option
                    defaultValue={allContent?.freeOrPaid}
                    className="bg-[#1B1B1B]"
                    disabled
                  >
                    {allContent?.freeOrPaid}
                  </option>
              ...
              <div className="pt-3">
                ...
                <textarea
                  cols="10"
                  rows="5"
                  defaultValue={allContent?.contentSummary}
                  id="contentSummary"
                  name="contentSummary"
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
              ...
              <div className="pt-3">
                ...
                <input
                  id="downloadUrl"
                  name="downloadUrl"
                  defaultValue={allContent?.downloadUrl}
                  type="text"
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
              ...
              <input
                ...
                value={allContent?.videoDownloadUrl}
                type="text"
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
                placeholder="enter your download video url"
                {...register("video", {
                  required: {
                    value: true,
                    message: "enter your video download url",
                  },
                })}
              />
              {errors.videoDownloadUrl && (
                <span className="text-red-500 text-sm pt-2 capitalize">
                  {errors.videoDownloadUrl.message}
                </span>
              )}
            </div> */}
              {/* Image */}
              ...
              <div className="pt-3">
                ...
                <input
                  id="lgImage"
                  name="lgImage"
                  defaultValue={allContent?.lgImage}
                  type="file"
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
                  {...register("lgImage", {
                    required: {
              ...
              <div className="pt-3">
                ...
                <input
                  id="smImage"
                  name="smImage"
                  defaultValue={allContent?.smImage}
                  type="file"
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700  text-slate-400  rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-[#1f296117]   mt-2"
                  {...register("smImage", {
                    required: {
            ...
            <div className="p-4 text-start">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
                ...
                <div className="w-full pt-4">
                  ...
                  <option
                    className="py-2 bg-[#1B1B1B]"
                    value="premium-movies-series"
                  >
                    প্রিমিয়াম মুভি ও সিরিজ
                  </option> */}
                    {/* <option value="sport">Sport</option> */}
                  </select>
                  <label className="">
