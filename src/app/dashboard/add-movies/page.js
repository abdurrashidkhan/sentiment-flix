...
import insertMovies from "@/database/insert/insertMovies";
...
export default function AddMovies() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const insertMovie = await insertMovies(insertData, setIsLoading, reset);
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="text-center md:text-start">
            <h1 className="text-2xl font-serif pt-4 pl-5">Add Movies</h1>
          </div>
          <div className="p-4 text-start">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
              ...
              <div className="w-full">
                ...
                >
                  <option className="bg-[#1B1B1B]" value="" disabled selected>
                    Select here
                  </option>
                  <option className="bg-[#1B1B1B]" value="paid">
                    Paid
                  </option>
                  <option className="bg-[#1B1B1B]" value="free">
                    Free
                  </option>
                </select>
                {errors.freeOrPaid && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-5">
              ...
              <div className="w-full pt-4">
                ...
                >
                  ...
                  <option className="py-2 bg-[#1B1B1B]" value="premium-movies">
                    প্রিমিয়াম মুভি
                  </option>
                  {/* <option value="sport">Sport</option> */}
                </select>
